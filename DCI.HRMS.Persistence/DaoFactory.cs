...
namespace DCI.HRMS.Persistence
{
    public abstract class DaoFactory : DaoFactoryBase
    {
        ...
        {
            DaoManager tmpDaoManager = DaoConfig.GetDaoManager("HRMS");
        ...
        public abstract IPenaltyDao CreatePenaltyDao();
        public abstract IPropertyBorrowDao CreatePropertyBorrowDao();
        public abstract ISkillAllowanceDao CreateSkillAllowanceDao();
        public abstract IBusinessTripDao CreateBusinessTripDao();
        public abstract ISatisfyDao CreareSatisfyDao();
        public abstract ILawResponseDao CreateLawResponseDao();
        public abstract IEvaluationDao CreateEvaluationDao();

        public abstract IWelfairDao CreateWlfairDao();
