...
namespace DCIBizPro.Util.Xml
{
    ...
    public class XmlTemplateGenerator {
        ...
        public XmlTemplateGenerator(string url, XmlQualifiedName rootElem) : this(XmlSchema.Read(new XmlTextReader(url), new ValidationEventHandler(ValidationCallBack)), rootElem) {
        }

        public XmlTemplateGenerator(XmlSchema schema, XmlQualifiedName rootElem) {
            if (schema == null) {
        ...
        public XmlTemplateGenerator(XmlSchemaSet schemaSet, XmlQualifiedName rootElem) {
