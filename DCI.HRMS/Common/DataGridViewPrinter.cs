...
namespace DCI.HRMS.Common
{
    class DataGridViewPrinter
    {
        ...
        private Font TheRowFont; // The font to be used with the title text (if IsWithTitle is set to true)
        ...
        public DataGridViewPrinter(DataGridView aDataGridView, PrintDocument aPrintDocument, bool CenterOnPage, bool WithTitle, string aTitleText, Font aTitleFont,Font aRowFont, Color aTitleColor, bool WithPaging)
        {
            TheDataGridView = aDataGridView;
            ThePrintDocument = aPrintDocument;
            IsCenterOnPage = CenterOnPage;
        ...
        private void DrawHeader(Graphics g)
        {
            ...
            if (IsWithPaging)
            {
                ...
                Font PageStringFont;
                PageStringFont = TheRowFont;
                if (PageStringFont == null)
                    PageStringFont = new Font("Tahoma", 8, FontStyle.Regular, GraphicsUnit.Point);
            ...
            Font HeaderFont;
            HeaderFont = TheRowFont;
            if (HeaderFont == null)
                HeaderFont = TheDataGridView.ColumnHeadersDefaultCellStyle.Font;
