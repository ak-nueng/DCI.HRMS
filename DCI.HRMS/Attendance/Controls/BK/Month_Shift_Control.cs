...
{
    public partial class Month_Shift_Control : UserControl
    {
       ...
       public delegate void grp_ChangeHandler();
        ...
        public Month_Shift_Control(MonthShiftInfo _shIfo)
        {
            InitializeComponent();
        ...
        public ArrayList ShtType
        {
            set
            {
                ...
                foreach (BasicInfo shtype in shtType)
                {
                    cmBoxShtype.Items.Add(shtype.Code);
                }
                cmBoxShtype.SelectedItem= "D";
