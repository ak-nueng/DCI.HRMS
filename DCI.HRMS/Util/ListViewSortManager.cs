...
namespace DCI.HRMS.Util
{
	...
	public class ListViewSortManager
	{
		...
		{
			get { return m_list.ListViewItemSorter != null; }
		...
		private static extern IntPtr SendMessage2(IntPtr Handle, Int32 msg, IntPtr wParam, ref HDITEM lParam);
		...
		private const Int32 HDI_FILTER = 0x0100; // 0x0500
		...
		private const Int32 HDF_SORTUP = 0x0400; // 0x0501
		private const Int32 HDF_SORTDOWN = 0x0200; // 0x0501
