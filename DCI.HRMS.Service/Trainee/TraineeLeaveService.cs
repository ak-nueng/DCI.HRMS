...
{
    public  class TraineeLeaveService
    {
        private static readonly TraineeLeaveService instance = new TraineeLeaveService();
        ...
        private TraineeService empSvr = TraineeService.Instance();

        internal TraineeLeaveService()
        {
        ...
        public static TraineeLeaveService Instance()
        {
        ...
        public ArrayList GetLeaveTotal(string code, DateTime caldate)
        {
            ...
            DateTime startcal = DateTime.Parse("01/JAN/" + caldate.Year.ToString());
            DateTime endtcal = DateTime.Parse("31/DEC/" + caldate.Year.ToString());
        ...
        public ArrayList GetAnnualTotal(string emcode, DateTime joinDt, DateTime caldate)
        {
           ...
           ArrayList annutotal = new ArrayList();
            ...
            if (joinDt >= DateTime.Parse("01/JUL/" + calyear.ToString()))
            {
                calyear++;
            }
            ...
            if (emcode.StartsWith("6"))
            {
                ...
                {
                    DateTime startAnnu = DateTime.Parse("01/JUL/" + calyear.ToString());
                    DateTime endAnnu = DateTime.Parse("30/JUN/" + (calyear + 1).ToString());
