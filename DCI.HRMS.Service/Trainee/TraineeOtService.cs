...
{
  public  class TraineeOtService
    {
        private static TraineeOtService instance = new TraineeOtService();

        private TraineeDaoFactory factory = TraineeDaoFactory.Instance();

        private IOTDao otDao;

        private TraineeOtService()
        {
            otDao = factory.CreateOtDao();

        }
        public static TraineeOtService Instance()
        {
            return instance;
        }
