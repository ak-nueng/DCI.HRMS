...
namespace DCI.HRMS.Service
{
    public class ShiftService
    {
        ...
        private static readonly ShiftService instance = new ShiftService();
        ...
        public ArrayList GetEmpDVCDGrpOT(string empdvcd)
        {
            try
            {
                factory.StartTransaction(true);
                return factory.CreateShiftDao().GetDVCDGrpOT(empdvcd);
            }
            catch
            {
                return null;
